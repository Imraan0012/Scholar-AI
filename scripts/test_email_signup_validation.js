...
function runTests() {
  console.log('=============================================================================');
  console.log('SCHOLAR AI — EMAIL VALIDATION & NORMALIZATION TEST SUITE');
  console.log('=============================================================================');
  ...
  console.log('✅ TEST 1 PASSED: mohamedimraan2003@gmail.com is strictly accepted.');
  ...
  console.log('✅ TEST 2 PASSED: malformed "abc" is rejected.');
  ...
  console.log('✅ TEST 3 PASSED: student@gmail.com accepted.');
  ...
  console.log('✅ TEST 4 PASSED: Leading/trailing whitespace properly trimmed.');
  ...
  console.log('✅ TEST 5 PASSED: Uppercase properly normalized to lowercase.');
  ...
  console.log('✅ TEST 6 PASSED: All standard public and institutional domains (.com, .in, .ac.in, .edu.in) accepted.');
