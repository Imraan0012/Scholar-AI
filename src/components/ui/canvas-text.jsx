...
export function CanvasText({
  ...
  useEffect(() => {
    ...
    const animate = (currentTime) => {
      ...
      // Mask text area with high-opacity bright gradient
      ctx.globalCompositeOperation = "source-in";
      const baseGradient = ctx.createLinearGradient(0, 0, width, 0);
      baseGradient.addColorStop(0, "rgba(255, 255, 255, 0.95)");
      baseGradient.addColorStop(0.4, "rgba(167, 139, 250, 0.9)");
      baseGradient.addColorStop(0.8, "rgba(56, 189, 248, 0.95)");
      baseGradient.addColorStop(1, "rgba(52, 211, 153, 0.95)");
      ctx.fillStyle = baseGradient;
      ctx.fillRect(0, 0, width, height);

      // Draw animated lines atop masked text
