...
export default function HowItWorksSection({ onCheckEligibilityClick }) {
  const steps = [
    ...
    },
    {
      ...
      subtitle: "Cross-Checking 12,500+ Official Scheme Rules",
      desc: "Our neural matching algorithm evaluates every clause across Central NSP, State DBT portals, AICTE/UGC, and Corporate Trusts.",
      icon: Cpu,
